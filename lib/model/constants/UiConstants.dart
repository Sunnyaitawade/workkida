...
class UIData {
  ...
  //strings
  static const String appName = "Work Kida";

  static const SERVER_NAME = "192.168.1.34";//your server's ip address
  static const URL_CATEGORY = "http://$SERVER_NAME:3000/todos";

  //category pages
  static const String categoryHome = "Category";

  //MyPost pages
  static const String myPostHome = "My Posts";

  //Settings pages
  static const String settingHome = "My settings";
  //Dashboard pages
  static const String bottomHome = "Home";
  static const String bottomPost = "Post";
  static const String bottomSearch = "Search";
  static const String bottomFav= "Favourites";
  static const String bottomMyPost= "My Posts";
  static const String bottomProfile= "My Account";
  //routes
  ...
  static const String flashImage = "$imageDir/serviceproviderslist.png";
  static const String flashheartImage = "$imageDir/heartbeat.png";
